...
<html>
	...
	<body>
		<form action="<?php echo $PayWeb3::$process_url ?>" method="post" name="paygate_process_form">
			...
			<span id="PAYGATE_ID"><?php echo $data['PAYGATE_ID']; ?></span>
			<br>
			<label for="REFERENCE">Reference</label>
			<span id="REFERENCE"><?php echo $data['REFERENCE']; ?></span>
			<br>
			<label for="AMOUNT">Amount</label>
			<span id="AMOUNT"><?php echo $data['AMOUNT']; ?></span>
			<br>
			<label for="CURRENCY">Currency</label>
			<span id="CURRENCY"><?php echo $data['CURRENCY']; ?></span>
			<br>
			<label for="RETURN_URL">Return URL</label>
			<span id="RETURN_URL"><?php echo $data['RETURN_URL']; ?></span>
			<br>
			<label for="LOCALE">Locale</label>
			<span id="LOCALE"><?php echo $data['LOCALE']; ?></span>
			<br>
			<label for="COUNTRY">Country</label>
			<span id="COUNTRY"><?php echo $data['COUNTRY']; ?></span>
			<br>
			<label for="TRANSACTION_DATE">Transaction Date</label>
			<span id="TRANSACTION_DATE"><?php echo $data['TRANSACTION_DATE']; ?></span>
			<br>
...
HTML;
			...
			<span id="encryption_key"><?php echo $encryption_key; ?></span>
			<br>
