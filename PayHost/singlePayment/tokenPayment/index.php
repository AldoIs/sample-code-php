<?php
/*
 * This is an example page of the process required for a PayGate PayHost Token Card Payment transaction.
 */
...
<div class="container-fluid" style="min-width: 320px;">
		...
		<div class="container-fluid">
			...
			<div class="collapse navbar-collapse" id="navbar-collapse">
				<ul class="nav navbar-nav">
					<li class="active">
						<a href="/<?php echo $root; ?>/PayHost/singlePayment/tokenPayment/index.php">Initiate</a>
					</li>
					<li>
						<a href="/<?php echo $root; ?>/PayHost/singleFollowUp/query.php">Query</a>
					</li>
					<li>
						<a href="/<?php echo $root; ?>/PayHost/singleFollowup/simple_query.php">Simple
							Query</a>
					</li>
				</ul>
			</div>
	...
	<div style="background-color:#80b946; text-align: center; margin-top: 51px; margin-bottom: 15px; padding: 4px;">
		<strong>Initiate Token Card Payment</strong></div>
	<div class="container">
		<form role="form" class="form-horizontal text-left" action="index.php" method="post">
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-4">
					<button class="btn btn-primary btn-block" type="button" data-toggle="collapse"
					        data-target="#requestDiv" aria-expanded="false" aria-controls="requestDiv">
						Request
					</button>
				</div>
			</div>
...
<?php echo $request; ?>
			...
			<div class="form-group">
				<div class="col-sm-offset-4 col-sm-4">
					<img src="/<?php echo $root; ?>/lib/images/loader.gif" alt="Processing" class="initialHide"
					     id="authLoader">
            ...
            <?php if (isset($_POST['btnSubmit'])) { ?>
				<div class="form-group">
					<div class="col-sm-offset-4 col-sm-4">
						<button class="btn btn-primary btn-block" type="button" data-toggle="collapse"
						        data-target="#responseDiv" aria-expanded="false" aria-controls="responseDiv">
							Response
						</button>
					</div>
				</div>
        ...
        if (isset($_POST['btnSubmit'])) {
            if (!$err) {
                ...
                if (array_key_exists('Redirect', $result->CardPaymentResponse)) {
					...
					<div class="row">
						<div class="col-sm-offset-4 col-sm-4">
							<button id="showRedirectBtn" class="btn btn-warning btn-block" type="button"
							        data-toggle="collapse" data-target="#redirectDiv" aria-expanded="false"
							        aria-controls="redirectDiv">
								Redirect Required
							</button>
						</div>
					</div>
...
HTML;
					...
					<form role="form" class="form-horizontal text-left"
					      action="<?php echo $result->CardPaymentResponse->Redirect->RedirectUrl; ?>" method="post"
					      target="iframetest">
						...
						<div class="form-group">
							<div class="col-sm-offset-4 col-sm-4">
								<img src="/<?php echo $root; ?>/lib/images/loader.gif" alt="Processing"
								     class="initialHide" id="submitLoader">
								<input class="btn btn-success btn-block" type="submit" name="submitBtn" id="doSubmitBtn"
								       value="submit" data-toggle="modal" data-target="#authModal"/>
							</div>
						</div>
						<br>
					</form>
					...
					<div class="modal fade" id="authModal" tabindex="-1" role="dialog" aria-labelledby="3DAuthModal"
					     aria-hidden="true">
						<div class="modal-dialog">
							<div class="modal-content">
								...
								<div class="modal-body">
									<iframe name="iframetest" id="iframetest"
									        src="<?php echo $result->CardPaymentResponse->Redirect->RedirectUrl; ?>"
									        height="550" width="100%" frameborder="0" scrolling="auto"></iframe>
								</div>
