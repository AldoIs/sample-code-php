        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="/<?php echo $root; ?>/PayHost/singleFollowUp/void.php">Void</a>
                    </li>
                    <li>
                        <a href="/<?php echo $root; ?>/PayHost/singleFollowUp/simple_void.php">Simple void</a>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <div style="background-color:#57B7DF; text-align: center; margin-top: 51px; margin-bottom: 15px; padding: 4px;"><strong>Void</strong></div>
    <div class="container">
