<?php
/*
 * This is an example page of the form fields required for a PayGate PayHost Refund transaction.
 */
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="active">
                        <a href="/<?php echo $root; ?>/PayHost/singleFollowUp/refund.php">Refund</a>
                    </li>
                    <li>
                        <a href="/<?php echo $root; ?>/PayHost/singleFollowUp/simple_refund.php">Simple Refund</a>
                    </li>
                </ul>
            </div>
        </div>
    </nav>
    <div style="background-color:#80b946; text-align: center; margin-top: 51px; margin-bottom: 15px; padding: 4px;"><strong>Refund</strong></div>
    <div class="container">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <div class="input-group">
                        <input type="text" name="amount" id="amount" class="form-control" aria-label="amount input" value="<?php echo(isset($amount) ? $amount : PayHostSOAP::$DEFAULT_AMOUNT); ?>" />
                    </div>
                </div>
            </div>
            <div class="form-group">
