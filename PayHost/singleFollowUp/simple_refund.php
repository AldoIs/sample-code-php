...
<body>
<a href="/<?php echo $root; ?>/PayHost/singleFollowUp/refund.php">Back to Refund</a>
<br>
<form role="form" class="form-horizontal text-left" action="simple_refund.php" method="post">
    ...
    <input type="text" name="amount" id="amount" class="form-control" aria-label="amount input" value="<?php echo(isset($amount) ? $amount : PayHostSOAP::$DEFAULT_AMOUNT); ?>" /><br />
    ...
    <br>
    <input id="doQueryBtn" type="submit" name="btnSubmit" value="Do Refund" />
</form>
<?php
if (isset($_POST['btnSubmit'])){
    if(!$result){
