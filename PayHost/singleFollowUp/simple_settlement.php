...
<body>
<a href="/<?php echo $root; ?>/PayHost/singleFollowUp/settlement.php">Back to Settlement</a>
<br>
<form role="form" class="form-horizontal text-left" action="simple_settlement.php" method="post">
    ...
    <br>
    <input id="doQueryBtn" type="submit" name="btnSubmit" value="Do Settlement" />
</form>
<?php
if (isset($_POST['btnSubmit'])){
    if(!$result){
